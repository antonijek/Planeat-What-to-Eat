...
const PIECE_GRAMS: Record<string, number> = {
  ...
  apple: 150, apples: 150, jabuka: 150, jabuke: 150,
  banana: 120, bananas: 120, banane: 120,
  carrot: 65, carrots: 65, shargarepa: 65, šargarepa: 65, mrkva: 65, mrkve: 65,
  orange: 130, narandža: 130, narandze: 130,
  pepper: 90, paprika: 90, paprike: 90,
  lemon: 60, limun: 60, limuni: 60,
  lime: 60, limeta: 60, limete: 60,
  cucumber: 300, krastavac: 300, krastavci: 300,
  zucchini: 200, tikvica: 200, tikvice: 200,
  mushroom: 15, mushrooms: 15, pecurka: 15, pečurka: 15, pecurke: 15, pečurke: 15,
  kiwi: 70,
  peach: 150, peaches: 150, breskva: 150, breskve: 150,
  pear: 170, pears: 170, kruska: 170, kruška: 170, kruske: 170, kruške: 170,
  plum: 60, plums: 60, sljiva: 60, šljiva: 60, sljive: 60, šljive: 60,
  strawberry: 12, strawberries: 12, jagoda: 12, jagode: 12,
  blueberry: 2, blueberries: 2, borovnica: 2, borovnice: 2,
  raspberry: 4, raspberries: 4, malina: 4, maline: 4,
  cherry: 8, cherries: 8, trešnja: 8, trešnje: 8, višnja: 8, višnje: 8,
};
